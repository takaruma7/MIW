...
class UploadHandler {
    ...
    /**
     * Handle file upload with custom naming (Heroku-compatible)
     */
    ...
    /**
     * Legacy file upload method for backward compatibility with local development
     */
    public function handleLegacyUpload($file, $targetDir, $customName) {
        $this->errors = [];
    ...
    /**
     * Check if file exists (Heroku-compatible)
     */
    ...
    /**
     * Get file path (Heroku-compatible)
     */
    ...
    /**
     * Legacy check if file exists in upload directory
     * @param string $filepath Relative path to file
     * @return bool True if file exists
     */
    public function legacyFileExists($filepath) {

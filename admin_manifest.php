...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 admin-header d-flex justify-content-between align-items-center">
                <h2><i class="bi bi-list-check"></i> Manifest Management</h2>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-body p-0">
                        <ul class="nav nav-tabs nav-fill" id="manifestTabs" role="tablist">
                ...
                <div class="tab-content manifest-tab-content" id="manifestTabsContent">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var firstTab = document.querySelector('#manifestTabs .nav-link');
        var firstPane = document.querySelector('#manifestTabsContent .tab-pane');

<?php
/**
 * MIW Travel Management System - Simplified Configuration
 * 
...
function loadLocalConfig() {
    ...
    // Email functionality settings
    define('EMAIL_ENABLED', false); // Disabled for local development
    define('EMAIL_FROM', 'noreply@miw-travel.local');
    define('EMAIL_FROM_NAME', 'MIW Travel (Local)');
    ...
    try {
        ...
        error_log("MySQL connection failed in local environment: " . $e->getMessage());
...
/**
 * Create MySQL connection (for local development)
 */
...
// Environment indicator for debugging (local only)
if (!isProduction()) {
